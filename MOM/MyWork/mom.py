from MyWork.MOMParser import MomParser
import re 
import argparse
    ...
    def mom(self):# print element
        ...
        if self.mo == "":    
            ...
            if self.attr != "":
                ...
                print line
                p = re.compile(self.attr, re.IGNORECASE)
                for attr_name in self.attrs:
                    check = p.search(self.attr)
                    if check:
            ...
            for moc in self.mos:
                ...
                if check:   
                    ...
                    if self.attr == "":
                        ...
                        print line
                        m = re.compile(self.attr, re.IGNORECASE)
